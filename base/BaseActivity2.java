...
public abstract class BaseActivity2 extends AppCompatActivity implements IViewController, ITitleController, IFragmentController {
    public String TAG;
    ...
    protected LoadingPopupView getLoadingPopupView(XPopupCallback xPopupCallback) {
    ...
    public void setTitleBack(View.OnClickListener onClickListener, boolean z) {
        if (z) {
            ...
            if (onClickListener != null) {
                ...
                this.mTitleLeftIconImg.setOnClickListener(new View.OnClickListener() { // from class: com.movieboxpro.android.base.BaseActivity2.1
    ...
    public void showNoInternetDialog() {
        new NoInternetDialog(this, new NoInternetDialog.OnButtonClickListener() { // from class: com.movieboxpro.android.base.BaseActivity2.2
            @Override // com.movieboxpro.android.view.dialog.NoInternetDialog.OnButtonClickListener
            public void onClick() {
                BaseActivity2.this.onTryAgainClick();
            }
        }).show();
    }
    ...
    public void showAlert(String str) {
        new com.adorkable.iosdialog.AlertDialog(this.context).builder().setTitle("Note").setMsg(str).setNegativeButton("OK", new View.OnClickListener() { // from class: com.movieboxpro.android.base.BaseActivity2.3
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
            }
