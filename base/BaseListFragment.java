...
public abstract class BaseListFragment<T, P> extends BaseLazyFragment {
    ...
    protected BaseQuickAdapter<T, com.chad.library.adapter.base.viewholder.BaseViewHolder> initAdapter() {
        return null;
    }
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() { // from class: com.movieboxpro.android.base.-$$Lambda$BaseListFragment$VaW26Ax7Wq_41k9I1CKNU-MpqRQ
    ...
    private void init() {
        ...
        BaseQuickAdapter<T, com.chad.library.adapter.base.viewholder.BaseViewHolder> initAdapter = initAdapter();
        if (initAdapter == null) {
            if (enableDragAdapter()) {
                this.mAdapter = new BaseDragLoadMoreAdapter<T, com.chad.library.adapter.base.viewholder.BaseViewHolder>(initItemLayout(), this.mData) { // from class: com.movieboxpro.android.base.BaseListFragment.1
            ...
            } else if (enableMultiAdapter()) {
                this.mAdapter = new MultiItemAdapter();
            } else {
                this.mAdapter = new BaseLoadMoreAdapter<T, com.chad.library.adapter.base.viewholder.BaseViewHolder>(initItemLayout(), this.mData) { // from class: com.movieboxpro.android.base.BaseListFragment.2
                    @Override // com.chad.library.adapter.base.BaseQuickAdapter
                    protected void convert(com.chad.library.adapter.base.viewholder.BaseViewHolder baseViewHolder, T t) {
                        BaseListFragment.this.initHolder(baseViewHolder, t);
                    }
        ...
        if (isOpenLoadMore()) {
            this.loadMoreModule.setOnLoadMoreListener(new OnLoadMoreListener() { // from class: com.movieboxpro.android.base.-$$Lambda$BaseListFragment$Yzf5hYiHbgXGmgqNkceUZLDTtvc
    ...
    private void loadData() {
        ((ObservableSubscribeProxy) getServiceData().compose(RxUtils.rxTranslate2List(this.mClass)).compose(RxUtils.rxSchedulerHelper()).as(RxUtils.bindLifecycleOwner(this))).subscribe(new BaseObserver<List<T>>() { // from class: com.movieboxpro.android.base.BaseListFragment.3
    ...
    private void loadDataWithModel() {
        ...
        ((ObservableSubscribeProxy) getServiceData().compose(RxUtils.rxTranslate2Bean(this.mPageClass)).compose(RxUtils.rxSchedulerHelper()).as(RxUtils.bindLifecycleOwner(this))).subscribe(new BaseObserver<P>() { // from class: com.movieboxpro.android.base.BaseListFragment.4
            @Override // com.movieboxpro.android.base.BaseObserver, io.reactivex.Observer
    ...
    private void loadMoreDataPage() {
        ((ObservableSubscribeProxy) getServiceData().compose(RxUtils.rxTranslate2List(this.mClass)).compose(RxUtils.rxSchedulerHelper()).as(RxUtils.bindLifecycleOwner(this))).subscribe(new BaseObserver<List<T>>() { // from class: com.movieboxpro.android.base.BaseListFragment.5
            @Override // com.movieboxpro.android.base.BaseObserver, io.reactivex.Observer
            public /* bridge */ /* synthetic */ void onNext(Object obj) {
                onNext((List) ((List) obj));
            }
    ...
    private void loadMoreDataPageModel() {
        ((ObservableSubscribeProxy) getServiceData().compose(RxUtils.rxTranslate2Bean(this.mPageClass)).compose(RxUtils.rxSchedulerHelper()).as(RxUtils.bindLifecycleOwner(this))).subscribe(new BaseObserver<P>() { // from class: com.movieboxpro.android.base.BaseListFragment.6
            @Override // com.movieboxpro.android.base.BaseObserver, io.reactivex.Observer
            public void onSubscribe(Disposable disposable) {
                super.onSubscribe(disposable);
                if (BaseListFragment.this.mCurrentPage == 1) {
    ...
    public void setErrorView(String str) {
        ...
        textView.setOnClickListener(new View.OnClickListener() { // from class: com.movieboxpro.android.base.BaseListFragment.7
    ...
    private void setNotLoginError() {
        ...
        if (view == null) {
            ...
            textView.setOnClickListener(new View.OnClickListener() { // from class: com.movieboxpro.android.base.BaseListFragment.8
                @Override // android.view.View.OnClickListener
            ...
            textView2.setOnClickListener(new View.OnClickListener() { // from class: com.movieboxpro.android.base.BaseListFragment.9
                @Override // android.view.View.OnClickListener
                public void onClick(View view2) {
                    Login2Activity.start(BaseListFragment.this.getContext());
                }
    ...
    public class MultiItemAdapter extends BaseLoadmoreDelegateMultiAdapter<T, com.chad.library.adapter.base.viewholder.BaseViewHolder> {
        MultiItemAdapter() {
            super(null);
            BaseMultiTypeDelegate<T> baseMultiTypeDelegate = new BaseMultiTypeDelegate<T>() { // from class: com.movieboxpro.android.base.BaseListFragment.MultiItemAdapter.1
