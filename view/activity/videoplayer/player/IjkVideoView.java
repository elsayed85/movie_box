...
public class IjkVideoView extends BaseIjkVideoView {
    ...
    private void addSurfaceView() {
        ...
        holder.addCallback(new SurfaceHolder.Callback() { // from class: com.movieboxpro.android.view.activity.videoplayer.player.IjkVideoView.1
    ...
    private void addTextureView() {
        ...
        resizeTextureView.setSurfaceTextureListener(new TextureView.SurfaceTextureListener() { // from class: com.movieboxpro.android.view.activity.videoplayer.player.IjkVideoView.2
    ...
    public void onWindowFocusChanged(boolean z) {
        ...
        if (isInPlaybackState()) {
            if (this.mPlayerConfig.mAutoRotate || this.mIsFullScreen) {
                if (z) {
                    postDelayed(new Runnable() { // from class: com.movieboxpro.android.view.activity.videoplayer.player.IjkVideoView.3
