...
public abstract class BaseVideoController extends FrameLayout {
    ...
    public BaseVideoController(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mShowProgress = new Runnable() { // from class: com.movieboxpro.android.view.activity.vlcvideoplayer.controller.BaseVideoController.3
        ...
        this.mFadeOut = new Runnable() { // from class: com.movieboxpro.android.view.activity.vlcvideoplayer.controller.BaseVideoController.4
            @Override // java.lang.Runnable
            public void run() {
    ...
    protected void inflateStatusView() {
        if (this.mStatusView == null) {
            ...
            statusView.setReportListener(new View.OnClickListener() { // from class: com.movieboxpro.android.view.activity.vlcvideoplayer.controller.-$$Lambda$BaseVideoController$F1f9lRiAasuWsze44lSNpJKD3W8
    ...
    public void showErrorView(String str) {
        ...
        this.mStatusView.setButtonTextAndAction(getResources().getString(R.string.dkplayer_retry), new View.OnClickListener() { // from class: com.movieboxpro.android.view.activity.vlcvideoplayer.controller.BaseVideoController.1
            @Override // android.view.View.OnClickListener
    ...
    public void showStatusView(String str) {
        ...
        this.mStatusView.setMessage(str);
        this.mStatusView.hideReport();
        this.mStatusView.setButtonTextAndAction(getResources().getString(R.string.dkplayer_continue_play), new View.OnClickListener() { // from class: com.movieboxpro.android.view.activity.vlcvideoplayer.controller.BaseVideoController.2
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                BaseVideoController.this.hideStatusView();
