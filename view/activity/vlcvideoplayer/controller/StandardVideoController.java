...
public abstract class StandardVideoController extends GestureVideoController implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, PlayerController {
    ...
    public StandardVideoController(Context context, AttributeSet attributeSet, int i) {
        ...
        this.hideBackwardRunnable = new Runnable() { // from class: com.movieboxpro.android.view.activity.vlcvideoplayer.controller.StandardVideoController.4
            @Override // java.lang.Runnable
            public void run() {
                StandardVideoController.this.tvBackward.setVisibility(8);
            }
        };
        this.hideForwardRunnable = new Runnable() { // from class: com.movieboxpro.android.view.activity.vlcvideoplayer.controller.StandardVideoController.5
            @Override // java.lang.Runnable
            public void run() {
                StandardVideoController.this.tvForward.setVisibility(8);
            }
        };
        this.hideContinueText = new Runnable() { // from class: com.movieboxpro.android.view.activity.vlcvideoplayer.controller.StandardVideoController.6
            @Override // java.lang.Runnable
            public void run() {
                StandardVideoController.this.llContinue.setVisibility(8);
            }
        };
        this.showBaseViewRunnable = new Runnable() { // from class: com.movieboxpro.android.view.activity.vlcvideoplayer.controller.StandardVideoController.17
            @Override // java.lang.Runnable
            public void run() {
    ...
    public void initView() {
        ...
        imageView8.setOnClickListener(new View.OnClickListener() { // from class: com.movieboxpro.android.view.activity.vlcvideoplayer.controller.StandardVideoController.1
    ...
    private void initListener() {
        this.rgSkip.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() { // from class: com.movieboxpro.android.view.activity.vlcvideoplayer.controller.StandardVideoController.2
    ...
    public void setBufferProgress(int i) {
        ...
        this.tvTcpSpeed.setVisibility(0);
    ...
    private void startShowTcpSpeed() {
        ...
        Observable.interval(1L, TimeUnit.SECONDS).compose(RxUtils.rxSchedulerHelper()).subscribe(new Observer<Long>() { // from class: com.movieboxpro.android.view.activity.vlcvideoplayer.controller.StandardVideoController.3
    ...
    protected void showForwardBackView(int i) {
        ...
        if (i > 0) {
            ...
            this.mMediaPlayer.seekTo(this.mMediaPlayer.getCurrentPosition() + C.DEFAULT_SEEK_FORWARD_INCREMENT_MS);
            return;
        }
        showBackward();
    ...
    public void onStopTrackingTouch(SeekBar seekBar) {
        long duration = this.mVideoProgress.getMax() != 0 ? (this.mMediaPlayer.getDuration() * seekBar.getProgress()) / this.mVideoProgress.getMax() : 0L;
        VideoPreviewListener videoPreviewListener = this.videoPreviewListener;
        if (videoPreviewListener != null) {
    ...
    public void showRecommendSkipTime(final int i, final boolean z, final String str, final String str2, final int i2, final int i3, final FragmentManager fragmentManager, final DialogAction.ActionListener actionListener) {
        ...
        if (z) {
            this.ivCloseContinue.setVisibility(8);
            final Runnable runnable = new Runnable() { // from class: com.movieboxpro.android.view.activity.vlcvideoplayer.controller.StandardVideoController.8
                @Override // java.lang.Runnable
                public void run() {
                    StandardVideoController.this.llContinue.setVisibility(8);
            ...
            fontSize.append(" " + i + "S ").setForegroundColor(Color.parseColor("#0579FF")).setFontSize(17, true).setClickSpan(new CustomClickableSpan(Color.parseColor("#0579FF"), true) { // from class: com.movieboxpro.android.view.activity.vlcvideoplayer.controller.StandardVideoController.10
                @Override // android.text.style.ClickableSpan
                public void onClick(View view) {
                    StandardVideoController.this.llContinue.setVisibility(8);
            ...
            }).append(", ").setForegroundColor(Color.parseColor("#A1FFFFFF")).setFontSize(17, true).append(" RESTART").setForegroundColor(Color.parseColor("#0579FF")).setFontSize(17, true).setClickSpan(new CustomClickableSpan(Color.parseColor("#0579FF"), false) { // from class: com.movieboxpro.android.view.activity.vlcvideoplayer.controller.StandardVideoController.9
                @Override // android.text.style.ClickableSpan
                public void onClick(View view) {
                    StandardVideoController.this.mMediaPlayer.seekTo(0L);
                    StandardVideoController.this.llContinue.setVisibility(8);
        ...
        fontSize2.append(" " + i + "S ").setForegroundColor(Color.parseColor("#0579FF")).setFontSize(17, true).setClickSpan(new CustomClickableSpan(Color.parseColor("#0579FF"), true) { // from class: com.movieboxpro.android.view.activity.vlcvideoplayer.controller.StandardVideoController.12
            @Override // android.text.style.ClickableSpan
            public void onClick(View view) {
                SkipTimeFragment.Companion.newInstance(str, str2, i2, i3, true).show(fragmentManager, SkipTimeFragment.class.getSimpleName());
            }
        }).append(",   ").setForegroundColor(Color.parseColor("#A1FFFFFF")).setFontSize(17, true).append("NEXT").setForegroundColor(Color.parseColor("#0579FF")).setFontSize(17, true).setClickSpan(new CustomClickableSpan(Color.parseColor("#0579FF"), true) { // from class: com.movieboxpro.android.view.activity.vlcvideoplayer.controller.StandardVideoController.11
            @Override // android.text.style.ClickableSpan
            public void onClick(View view) {
                if (z) {
    ...
    public void showSkipTime(int i, boolean z, final String str, final String str2, final int i2, final int i3, final FragmentManager fragmentManager) {
        ...
        fontSize.append(" " + i + "S ").setForegroundColor(Color.parseColor("#0579FF")).setFontSize(17, true).setClickSpan(new CustomClickableSpan(Color.parseColor("#0579FF"), true) { // from class: com.movieboxpro.android.view.activity.vlcvideoplayer.controller.StandardVideoController.14
            @Override // android.text.style.ClickableSpan
            public void onClick(View view) {
                SkipTimeFragment.Companion.newInstance(str, str2, i2, i3).show(fragmentManager, SkipTimeFragment.class.getSimpleName());
            }
        }).append(", ").setForegroundColor(Color.parseColor("#A1FFFFFF")).setFontSize(17, true).append(" RESTART").setForegroundColor(Color.parseColor("#0579FF")).setFontSize(17, true).setClickSpan(new CustomClickableSpan(Color.parseColor("#0579FF"), false) { // from class: com.movieboxpro.android.view.activity.vlcvideoplayer.controller.StandardVideoController.13
            @Override // android.text.style.ClickableSpan
            public void onClick(View view) {
                StandardVideoController.this.mMediaPlayer.seekTo(0L);
                StandardVideoController.this.llContinue.setVisibility(8);
    ...
    public void showWillSkipTime(int i, boolean z, final String str, final String str2, final int i2, final int i3, final FragmentManager fragmentManager) {
        ...
        SpanUtils.with(this.tvContinue).append(str3).setForegroundColor(Color.parseColor("#A1FFFFFF")).setFontSize(15, true).append(i + "s,").setForegroundColor(Color.parseColor("#0579FF")).setFontSize(15, true).setClickSpan(new CustomClickableSpan(Color.parseColor("#0579FF"), false) { // from class: com.movieboxpro.android.view.activity.vlcvideoplayer.controller.StandardVideoController.16
            @Override // android.text.style.ClickableSpan
            public void onClick(View view) {
                SkipTimeFragment.Companion.newInstance(str, str2, i2, i3).show(fragmentManager, SkipTimeFragment.class.getSimpleName());
            }
        }).append(" Restart").setForegroundColor(Color.parseColor("#0579FF")).setFontSize(15, true).setClickSpan(new CustomClickableSpan(Color.parseColor("#0579FF"), false) { // from class: com.movieboxpro.android.view.activity.vlcvideoplayer.controller.StandardVideoController.15
            @Override // android.text.style.ClickableSpan
            public void onClick(View view) {
                StandardVideoController.this.mMediaPlayer.seekTo(0L);
                StandardVideoController.this.llContinue.setVisibility(8);
    ...
    private void show(int i) {
        if (this.isPlaying && this.mMediaPlayer != null) {
            ...
            this.mVideoProgress.setProgress(currentPosition / 1000);
            this.mVideoProgress.setMax(duration / 1000);
        }
        TextView textView3 = this.mSysTime;
        if (textView3 != null) {
    ...
    public int setProgress(int i, int i2) {
        if (this.mShowing && this.mMediaPlayer != null && !this.mIsDragging) {
            this.mVideoProgress.setProgress(i / 1000);
            this.mVideoProgress.setMax(i2 / 1000);
            TextView textView = this.mTotalTime;
            if (textView != null) {
                textView.setText(stringForTime(i2 - i));
            }
            TextView textView2 = this.mCurrTime;
            if (textView2 != null) {
