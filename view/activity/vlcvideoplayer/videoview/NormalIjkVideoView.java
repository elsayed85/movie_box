...
public class NormalIjkVideoView extends IjkVideoView implements NormalPlayerPresenter {
    ...
    @Override // com.movieboxpro.android.view.activity.vlcvideoplayer.player.IjkVideoView, com.movieboxpro.android.view.activity.vlcvideoplayer.controller.MediaPlayerControl
    ...
    public List<MediaPlayer.TrackDescription> getAudioTracks() {
        if (this.mVideoController != null) {
            this.mVideoController.getAudioTracks(super.getAudioTracks());
        }
        return super.getAudioTracks();
    }

    @Override // com.movieboxpro.android.view.activity.vlcvideoplayer.player.IjkVideoView, com.movieboxpro.android.view.activity.vlcvideoplayer.player.BaseIjkVideoView, com.movieboxpro.android.view.activity.vlcvideoplayer.controller.MediaPlayerControl
    public void release() {
        super.release();
        this.mCallBack = null;
    }

    @Override // com.movieboxpro.android.view.activity.vlcvideoplayer.player.IjkVideoView, com.movieboxpro.android.view.activity.vlcvideoplayer.listener.PlayerEventListener
