...
final class ReplyActivity$ReplyListFragment$addHeaderView$imgAdapter$1 extends Lambda implements Function2<BaseViewHolder, ImageItem, Unit> {
    final /* synthetic */ ReplyActivity.ReplyListFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ReplyActivity$ReplyListFragment$addHeaderView$imgAdapter$1(ReplyActivity.ReplyListFragment replyListFragment) {
        super(2);
