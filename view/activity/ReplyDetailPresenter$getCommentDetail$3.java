...
public final class ReplyDetailPresenter$getCommentDetail$3 extends Lambda implements Function1<ReviewResponse, Unit> {
    final /* synthetic */ ReplyDetailPresenter this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ReplyDetailPresenter$getCommentDetail$3(ReplyDetailPresenter replyDetailPresenter) {
        super(1);
    ...
    public final void invoke2(ReviewResponse it) {
        ...
        if (list != null && (list.isEmpty() ^ true)) {
            this.this$0.getView().showReview(it.getList().get(0));
        }
    }
}
