...
public abstract class StandardVideoController extends GestureVideoController implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, PlayerController {
    ...
    public StandardVideoController(Context context, AttributeSet attributeSet, int i) {
        ...
        this.hideBackwardRunnable = new Runnable() { // from class: com.movieboxpro.android.view.activity.exoplayer.controller.StandardVideoController.4
            @Override // java.lang.Runnable
            public void run() {
                StandardVideoController.this.tvBackward.setVisibility(8);
            }
        };
        this.hideForwardRunnable = new Runnable() { // from class: com.movieboxpro.android.view.activity.exoplayer.controller.StandardVideoController.5
            @Override // java.lang.Runnable
            public void run() {
                StandardVideoController.this.tvForward.setVisibility(8);
            }
        };
        this.hideContinueText = new Runnable() { // from class: com.movieboxpro.android.view.activity.exoplayer.controller.StandardVideoController.6
            @Override // java.lang.Runnable
            public void run() {
                StandardVideoController.this.llContinue.setVisibility(8);
            }
        };
        this.showBaseViewRunnable = new Runnable() { // from class: com.movieboxpro.android.view.activity.exoplayer.controller.StandardVideoController.16
            @Override // java.lang.Runnable
            public void run() {
    ...
    public void initView() {
        ...
        imageView8.setOnClickListener(new View.OnClickListener() { // from class: com.movieboxpro.android.view.activity.exoplayer.controller.StandardVideoController.1
    ...
    private void initListener() {
        this.rgSkip.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() { // from class: com.movieboxpro.android.view.activity.exoplayer.controller.StandardVideoController.2
    ...
    private void startShowTcpSpeed() {
        ...
        Observable.interval(1L, TimeUnit.SECONDS).compose(RxUtils.rxSchedulerHelper()).subscribe(new Observer<Long>() { // from class: com.movieboxpro.android.view.activity.exoplayer.controller.StandardVideoController.3
    ...
    public void showRecommendSkipTime(final int i, final boolean z, final String str, final String str2, final int i2, final int i3, final FragmentManager fragmentManager, final DialogAction.ActionListener actionListener) {
        ...
        if (z) {
            this.ivCloseContinue.setVisibility(8);
            final Runnable runnable = new Runnable() { // from class: com.movieboxpro.android.view.activity.exoplayer.controller.StandardVideoController.8
                @Override // java.lang.Runnable
                public void run() {
                    StandardVideoController.this.llContinue.setVisibility(8);
            ...
            fontSize.append(" " + i + "S ").setForegroundColor(Color.parseColor("#0579FF")).setFontSize(17, true).setClickSpan(new CustomClickableSpan(Color.parseColor("#0579FF"), true) { // from class: com.movieboxpro.android.view.activity.exoplayer.controller.StandardVideoController.10
                @Override // android.text.style.ClickableSpan
                public void onClick(View view) {
                    StandardVideoController.this.llContinue.setVisibility(8);
    ...
    public void showSkipTime(int i, boolean z, final String str, final String str2, final int i2, final int i3, final FragmentManager fragmentManager) {
        ...
        fontSize.append(" " + i + "S ").setForegroundColor(Color.parseColor("#0579FF")).setFontSize(17, true).setClickSpan(new CustomClickableSpan(Color.parseColor("#0579FF"), true) { // from class: com.movieboxpro.android.view.activity.exoplayer.controller.StandardVideoController.15
            @Override // android.text.style.ClickableSpan
            public void onClick(View view) {
                SkipTimeFragment.Companion.newInstance(str, str2, i2, i3).show(fragmentManager, SkipTimeFragment.class.getSimpleName());
            }
        }).append(", ").setForegroundColor(Color.parseColor("#A1FFFFFF")).setFontSize(17, true).append(" RESTART").setForegroundColor(Color.parseColor("#0579FF")).setFontSize(17, true).setClickSpan(new CustomClickableSpan(Color.parseColor("#0579FF"), false) { // from class: com.movieboxpro.android.view.activity.exoplayer.controller.StandardVideoController.14
            @Override // android.text.style.ClickableSpan
            public void onClick(View view) {
                StandardVideoController.this.mMediaPlayer.seekTo(0L);
                StandardVideoController.this.llContinue.setVisibility(8);
