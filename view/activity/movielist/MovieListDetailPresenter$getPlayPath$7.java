...
public final class MovieListDetailPresenter$getPlayPath$7 extends Lambda implements Function1<Pair<? extends BaseMediaModel, ? extends BaseMediaModel>, Unit> {
    final /* synthetic */ Ref.IntRef $position;
    final /* synthetic */ MovieListDetailPresenter this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MovieListDetailPresenter$getPlayPath$7(MovieListDetailPresenter movieListDetailPresenter, Ref.IntRef intRef) {
        super(1);
    ...
    public final void invoke2(Pair<? extends BaseMediaModel, ? extends BaseMediaModel> pair) {
        ...
        if (pair.getFirst() instanceof TvDetail) {
            ...
            if (!z) {
                MovieListDetailContract.View view2 = this.this$0.getView();
                if (view2 != null) {
                    view2.goMoviePlayer(movieDetail);
                }
            } else {
                ToastUtils.showShort("NO RESOURCE", new Object[0]);
            }
        }
        MovieListDetailContract.View view3 = this.this$0.getView();
        if (view3 == null) {
            return;
        }
