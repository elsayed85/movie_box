...
public final class ReplyActivity$ReplyListFragment$deleteComment$2 extends Lambda implements Function1<String, Unit> {
    final /* synthetic */ int $position;
    final /* synthetic */ ReplyActivity.ReplyListFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ReplyActivity$ReplyListFragment$deleteComment$2(ReplyActivity.ReplyListFragment replyListFragment, int i) {
        super(1);
