...
public final class TvDeviceActivity$getDevices$4$adapter$1$1$1 extends Lambda implements Function1<ApiException, Unit> {
    final /* synthetic */ TvDeviceActivity this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public TvDeviceActivity$getDevices$4$adapter$1$1$1(TvDeviceActivity tvDeviceActivity) {
        super(1);
