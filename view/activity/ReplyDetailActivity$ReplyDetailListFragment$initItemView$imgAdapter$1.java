...
public final class ReplyDetailActivity$ReplyDetailListFragment$initItemView$imgAdapter$1 extends Lambda implements Function2<BaseViewHolder, ImageItem, Unit> {
    final /* synthetic */ ReplyDetailActivity.ReplyDetailListFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ReplyDetailActivity$ReplyDetailListFragment$initItemView$imgAdapter$1(ReplyDetailActivity.ReplyDetailListFragment replyDetailListFragment) {
        super(2);
