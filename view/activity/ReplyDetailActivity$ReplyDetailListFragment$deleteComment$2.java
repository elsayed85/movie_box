...
public final class ReplyDetailActivity$ReplyDetailListFragment$deleteComment$2 extends Lambda implements Function1<String, Unit> {
    final /* synthetic */ int $position;
    final /* synthetic */ ReplyDetailActivity.ReplyDetailListFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ReplyDetailActivity$ReplyDetailListFragment$deleteComment$2(ReplyDetailActivity.ReplyDetailListFragment replyDetailListFragment, int i) {
        super(1);
