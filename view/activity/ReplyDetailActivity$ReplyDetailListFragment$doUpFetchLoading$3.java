...
final class ReplyDetailActivity$ReplyDetailListFragment$doUpFetchLoading$3 extends Lambda implements Function1<ReviewResponse, Unit> {
    final /* synthetic */ ReplyDetailActivity.ReplyDetailListFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ReplyDetailActivity$ReplyDetailListFragment$doUpFetchLoading$3(ReplyDetailActivity.ReplyDetailListFragment replyDetailListFragment) {
        super(1);
    ...
    public final void invoke2(ReviewResponse it) {
        ...
        if (list != null && (list.isEmpty() ^ true)) {
            ...
            baseQuickAdapter2.addData(0, (Collection) CollectionsKt.asReversed(it.getList()));
