...
public final class MoreWatchingActivity$WatchingListFragment$markTv$3 extends Lambda implements Function1<String, Unit> {
    final /* synthetic */ int $position;
    final /* synthetic */ MoreWatchingActivity.WatchingListFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MoreWatchingActivity$WatchingListFragment$markTv$3(MoreWatchingActivity.WatchingListFragment watchingListFragment, int i) {
        super(1);
