...
public final class ReplyActivity$sendReview$9 extends Lambda implements Function1<ArrayList<String>, Unit> {
    final /* synthetic */ String $content;
    final /* synthetic */ ReplyActivity this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ReplyActivity$sendReview$9(ReplyActivity replyActivity, String str) {
        super(1);
    ...
    public final void invoke2(ArrayList<String> it) {
        ...
        ((ReplyPresenter) basePresenter).sendReview(str, str2, str3, i, it);
    }
}
