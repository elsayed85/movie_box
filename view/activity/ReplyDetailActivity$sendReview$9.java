...
public final class ReplyDetailActivity$sendReview$9 extends Lambda implements Function1<ArrayList<String>, Unit> {
    final /* synthetic */ String $content;
    final /* synthetic */ ReplyDetailActivity this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ReplyDetailActivity$sendReview$9(ReplyDetailActivity replyDetailActivity, String str) {
        super(1);
    ...
    public final void invoke2(ArrayList<String> it) {
        ...
        ((ReplyDetailPresenter) basePresenter).sendReview(str, str2, str3, i, it);
    }
}
