...
public final class FavoriteFragment2$FavoriteListFragment$changeLikeStatus$1 extends Lambda implements Function1<ApiException, Unit> {
    final /* synthetic */ FavoriteFragment2.FavoriteListFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FavoriteFragment2$FavoriteListFragment$changeLikeStatus$1(FavoriteFragment2.FavoriteListFragment favoriteListFragment) {
        super(1);
