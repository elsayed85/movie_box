...
public final class ChildModeListFragment$remove$2 extends Lambda implements Function1<Disposable, Unit> {
    final /* synthetic */ ChildModeListFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ChildModeListFragment$remove$2(ChildModeListFragment childModeListFragment) {
        super(1);
