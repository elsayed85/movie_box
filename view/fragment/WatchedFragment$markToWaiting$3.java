...
final class WatchedFragment$markToWaiting$3 extends Lambda implements Function1<String, Unit> {
    final /* synthetic */ int $position;
    final /* synthetic */ WatchedFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WatchedFragment$markToWaiting$3(WatchedFragment watchedFragment, int i) {
        super(1);
