...
final class FeaturedPresenter$getPlayPath$6 extends Lambda implements Function1<ServerException, Unit> {
    public static final FeaturedPresenter$getPlayPath$6 INSTANCE = new FeaturedPresenter$getPlayPath$6();

    FeaturedPresenter$getPlayPath$6() {
        super(1);
    }
