...
public final class LikeNoticeFragment extends ReviewListFragment<ReviewModel, String> {
    ...
    protected Observable<String> getServiceData() {
        ...
        return service.getNotice(str, "mynotice", bbs_uid, author, auth, authkey, bBsInfo2.getFormhash(), CommonUtils.getBBSApiAPPID(), "like", "quote", this.mCurrentPage, this.mPageSize);
    }

    @Override // com.movieboxpro.android.view.activity.review.ReviewListFragment
    protected OnItemClickListener onItemClick() {
        return new OnItemClickListener() { // from class: com.movieboxpro.android.view.fragment.setting.-$$Lambda$LikeNoticeFragment$5TN4LSoZrBOpJp7I60Stz9zuan4
            @Override // com.chad.library.adapter.base.listener.OnItemClickListener
            public final void onItemClick(BaseQuickAdapter baseQuickAdapter, View view, int i) {
                LikeNoticeFragment.m1263onItemClick$lambda1(LikeNoticeFragment.this, baseQuickAdapter, view, i);
            }
        };
    }
    ...
    public static final void m1263onItemClick$lambda1(LikeNoticeFragment this$0, BaseQuickAdapter noName_0, View noName_1, int i) {
        ...
        ReviewDetailActivity.Companion.start(this$0.getContext(), "", reviewModel.getTid(), reviewModel, false);
    }

    @Override // com.movieboxpro.android.view.activity.review.ReviewListFragment
    protected OnItemChildClickListener onItemChildClick() {
        return new OnItemChildClickListener() { // from class: com.movieboxpro.android.view.fragment.setting.-$$Lambda$LikeNoticeFragment$wq_7WdUJQ2exV7vRkwtBqjxy4Vk
            @Override // com.chad.library.adapter.base.listener.OnItemChildClickListener
            public final void onItemChildClick(BaseQuickAdapter baseQuickAdapter, View view, int i) {
                LikeNoticeFragment.m1262onItemChildClick$lambda3(LikeNoticeFragment.this, baseQuickAdapter, view, i);
            }
        };
    }
    ...
    public static final void m1262onItemChildClick$lambda3(LikeNoticeFragment this$0, BaseQuickAdapter noName_0, View noName_1, int i) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(noName_0, "$noName_0");
        Intrinsics.checkNotNullParameter(noName_1, "$noName_1");
        ReviewModel reviewModel = (ReviewModel) this$0.mAdapter.getItem(i);
    ...
    protected void doSomethingWithData(List<ReviewModel> list) {
        if (this.mCurrentPage == 1) {
            EventBus.getDefault().post(new ChangeDotNumEvent(2, 0));
        }
    }
    ...
    /* compiled from: LikeNoticeFragment.kt */
    @Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0006\u0010\u0003\u001a\u00020\u0004¨\u0006\u0005"}, d2 = {"Lcom/movieboxpro/android/view/fragment/setting/LikeNoticeFragment$Companion;", "", "()V", "newInstance", "Lcom/movieboxpro/android/view/fragment/setting/LikeNoticeFragment;", "app_webRelease"}, k = 1, mv = {1, 6, 0}, xi = 48)
    /* loaded from: classes3.dex */
    public static final class Companion {
        ...
        public final LikeNoticeFragment newInstance() {
            LikeNoticeFragment likeNoticeFragment = new LikeNoticeFragment();
            likeNoticeFragment.setArguments(new Bundle());
