...
final class FeaturedPresenter$requestFeaturedData$3 extends Lambda implements Function1<ApiException, Unit> {
    final /* synthetic */ FeaturedPresenter this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FeaturedPresenter$requestFeaturedData$3(FeaturedPresenter featuredPresenter) {
        super(1);
    ...
    public final void invoke2(ApiException it) {
        ...
        FeaturedContract.View view = this.this$0.getView();
