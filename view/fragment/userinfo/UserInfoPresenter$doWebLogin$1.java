...
final class UserInfoPresenter$doWebLogin$1 extends Lambda implements Function1<ApiException, Unit> {
    final /* synthetic */ UserInfoPresenter this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public UserInfoPresenter$doWebLogin$1(UserInfoPresenter userInfoPresenter) {
        super(1);
    ...
    public final void invoke2(ApiException it) {
        ...
        if (it.getCode() == -101) {
            this.this$0.getView().deviceFull();
        }
    }
}
