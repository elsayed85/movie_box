...
@Metadata(d1 = {"\u0000\u001b\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003*\u0001\u0000\b\n\u0018\u00002\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00030\u0001J\u0018\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u00032\u0006\u0010\u0007\u001a\u00020\u0002H\u0014¨\u0006\b"}, d2 = {"com/movieboxpro/android/view/fragment/userinfo/UserInfoFragment3$initData$1", "Lcom/chad/library/adapter/base/BaseQuickAdapter;", "Lcom/movieboxpro/android/model/DrawerItem;", "Lcom/chad/library/adapter/base/viewholder/BaseViewHolder;", "convert", "", "holder", "item", "app_webRelease"}, k = 1, mv = {1, 6, 0}, xi = 48)
/* loaded from: classes3.dex */
public final class UserInfoFragment3$initData$1 extends BaseQuickAdapter<DrawerItem, BaseViewHolder> {
    final /* synthetic */ ArrayList<DrawerItem> $drawerItems;
    final /* synthetic */ UserInfoFragment3 this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public UserInfoFragment3$initData$1(ArrayList<DrawerItem> arrayList, UserInfoFragment3 userInfoFragment3) {
    ...
    public void convert(BaseViewHolder holder, DrawerItem item) {
        ...
        if (item.getType() == 14) {
            ...
            imageView2.setOnClickListener(new View.OnClickListener() { // from class: com.movieboxpro.android.view.fragment.userinfo.-$$Lambda$UserInfoFragment3$initData$1$zuf2TR5FIFSHr8z9xMaYsUesopc
                @Override // android.view.View.OnClickListener
                public final void onClick(View view2) {
                    UserInfoFragment3$initData$1.m1339convert$lambda2(UserInfoFragment3$initData$1.this, imageView2, view2);
                }
            });
            return;
        }
    ...
    public static final void m1339convert$lambda2(UserInfoFragment3$initData$1 this$0, final ImageView switchCompat, View view) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(switchCompat, "$switchCompat");
        if (PrefsUtils.getInstance().getBoolean(Constant.Prefs.Incognito_Mode, false)) {
            new MsgHintDialog.Builder(this$0.getContext()).setContent("Are you sure to turn off private mode? playback history and search history will be recorded and displayed").setCancelable(false).setActionListener(new DialogAction.ActionListener() { // from class: com.movieboxpro.android.view.fragment.userinfo.-$$Lambda$UserInfoFragment3$initData$1$orvWtXg79_twqDT7GOGNXitOvjM
                @Override // com.movieboxpro.android.view.dialog.DialogAction.ActionListener
                public final void onClick() {
                    UserInfoFragment3$initData$1.m1340convert$lambda2$lambda0(switchCompat);
                }
            }).create().show();
        } else {
            new MsgHintDialog.Builder(this$0.getContext()).setContent("Are you sure to turn on private mode? Hide watch and search history.").setCancelable(false).setActionListener(new DialogAction.ActionListener() { // from class: com.movieboxpro.android.view.fragment.userinfo.-$$Lambda$UserInfoFragment3$initData$1$dosRW-63CV2FjZcehCXJn2v2hHk
                @Override // com.movieboxpro.android.view.dialog.DialogAction.ActionListener
                public final void onClick() {
                    UserInfoFragment3$initData$1.m1341convert$lambda2$lambda1(switchCompat);
                }
            }).create().show();
        }
    }
    ...
    public static final void m1340convert$lambda2$lambda0(ImageView switchCompat) {
        Intrinsics.checkNotNullParameter(switchCompat, "$switchCompat");
    ...
    public static final void m1341convert$lambda2$lambda1(ImageView switchCompat) {
        Intrinsics.checkNotNullParameter(switchCompat, "$switchCompat");
