...
final class UserInfoPresenter$doWebLogin$3 extends Lambda implements Function1<String, Unit> {
    final /* synthetic */ UserInfoPresenter this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public UserInfoPresenter$doWebLogin$3(UserInfoPresenter userInfoPresenter) {
        super(1);
