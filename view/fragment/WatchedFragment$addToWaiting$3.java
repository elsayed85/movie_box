...
public final class WatchedFragment$addToWaiting$3 extends Lambda implements Function1<String, Unit> {
    ...
    public WatchedFragment$addToWaiting$3(WatchedFragment watchedFragment, int i, int i2) {
        super(1);
