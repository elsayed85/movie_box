...
final class TranscodeOnlySubtitleFragment$initData$1$onEncodeSelected$2 extends Lambda implements Function1<ApiException, Unit> {
    final /* synthetic */ TranscodeOnlySubtitleFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public TranscodeOnlySubtitleFragment$initData$1$onEncodeSelected$2(TranscodeOnlySubtitleFragment transcodeOnlySubtitleFragment) {
        super(1);
