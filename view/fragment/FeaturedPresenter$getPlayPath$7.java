...
final class FeaturedPresenter$getPlayPath$7 extends Lambda implements Function1<Pair<? extends BaseMediaModel, ? extends BaseMediaModel>, Unit> {
    final /* synthetic */ Ref.IntRef $position;
    final /* synthetic */ FeaturedPresenter this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FeaturedPresenter$getPlayPath$7(FeaturedPresenter featuredPresenter, Ref.IntRef intRef) {
        super(1);
        ...
        if (pair.getFirst() instanceof TvDetail) {
            ...
            if (!z) {
                ...
                if (seasonDetail != null) {
                    ...
                    this.this$0.getView().goTvPlayer(tvDetail);
                } else {
            ...
            if (!z) {
                this.this$0.getView().goMoviePlayer(movieDetail);
            } else {
                ToastUtils.showShort("NO RESOURCE", new Object[0]);
            }
        }
