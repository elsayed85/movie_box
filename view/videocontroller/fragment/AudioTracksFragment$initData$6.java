...
public final class AudioTracksFragment$initData$6 extends Lambda implements Function2<BaseViewHolder, AudioTrackItem, Unit> {
    final /* synthetic */ AudioTracksFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AudioTracksFragment$initData$6(AudioTracksFragment audioTracksFragment) {
        super(2);
    ...
    public final void invoke2(BaseViewHolder helper, final AudioTrackItem item) {
        ...
        audioTrackItemAdapter.setOnItemClickListener(new OnItemClickListener() { // from class: com.movieboxpro.android.view.videocontroller.fragment.-$$Lambda$AudioTracksFragment$initData$6$UMifZslrdRun8rth3Wh_FwiB-6U
            @Override // com.chad.library.adapter.base.listener.OnItemClickListener
            public final void onItemClick(BaseQuickAdapter baseQuickAdapter, View view, int i) {
                AudioTracksFragment$initData$6.m1360invoke$lambda1(AudioTrackItem.this, audioTracksFragment, audioTrackItemAdapter, baseQuickAdapter, view, i);
            }
        });
    ...
    public static final void m1360invoke$lambda1(AudioTrackItem item, AudioTracksFragment this$0, AudioTrackItemAdapter adapter, BaseQuickAdapter noName_0, View noName_1, int i) {
