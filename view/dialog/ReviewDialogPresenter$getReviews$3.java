...
final class ReviewDialogPresenter$getReviews$3 extends Lambda implements Function1<ReviewResponse, Unit> {
    final /* synthetic */ ReviewDialogPresenter this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ReviewDialogPresenter$getReviews$3(ReviewDialogPresenter reviewDialogPresenter) {
        super(1);
    ...
    public final void invoke2(ReviewResponse it) {
        ...
        view.showReviews(new ArrayList(list));
    }
}
