...
public final class AddTvWatchDialog$changeWatched$3 extends Lambda implements Function1<String, Unit> {
    final /* synthetic */ int $watched;
    final /* synthetic */ AddTvWatchDialog this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AddTvWatchDialog$changeWatched$3(AddTvWatchDialog addTvWatchDialog, int i) {
        super(1);
    ...
    public final void invoke2(String it) {
        ...
        if (i == 0) {
            ...
            time2 = addTvWatchDialog.getTime();
