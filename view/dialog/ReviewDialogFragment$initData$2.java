...
final class ReviewDialogFragment$initData$2 extends Lambda implements Function2<BaseViewHolder, ReviewImage, Unit> {
    final /* synthetic */ ReviewDialogFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ReviewDialogFragment$initData$2(ReviewDialogFragment reviewDialogFragment) {
        super(2);
    ...
    public final void invoke2(BaseViewHolder helper, ReviewImage item) {
        ...
        GlideUtils.load(this.this$0.getContext(), item.getUri(), (ImageView) helper.getView(R.id.imageView));
    }
}
