...
public final class SkipTimeFragment$SkipTimeSettingFragment$getVideoImage$1 extends Lambda implements Function1<ApiException, Unit> {
    final /* synthetic */ SkipTimeFragment.SkipTimeSettingFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SkipTimeFragment$SkipTimeSettingFragment$getVideoImage$1(SkipTimeFragment.SkipTimeSettingFragment skipTimeSettingFragment) {
        super(1);
