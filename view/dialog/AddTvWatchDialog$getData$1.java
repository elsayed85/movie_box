...
public final class AddTvWatchDialog$getData$1 extends Lambda implements Function1<ApiException, Unit> {
    final /* synthetic */ AddTvWatchDialog this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AddTvWatchDialog$getData$1(AddTvWatchDialog addTvWatchDialog) {
        super(1);
    ...
    public final void invoke2(ApiException it) {
        ...
        addTvWatchPlanPopLayoutBinding.loadingView.showError(Intrinsics.stringPlus("Load failed:", it.getMessage()));
    }
}
