...
public final class AddTvWatchDialog$markTv$3 extends Lambda implements Function1<String, Unit> {
    ...
    public AddTvWatchDialog$markTv$3(AddTvWatchDialog addTvWatchDialog, FavoriteSeasonItem favoriteSeasonItem, String str, FavoriteEpisodeItem favoriteEpisodeItem, String str2, int i, int i2) {
        super(1);
    ...
    public final void invoke2(String it) {
        ...
        if (favoriteSeasonItem2 != null) {
            ...
            seasonEpisodeAdapter16 = addTvWatchDialog.adapter;
        ...
        if ((!StringsKt.isBlank(this.$episode)) && (favoriteEpisodeItem = this.$favoriteEpisodeItem) != null) {
            ...
            if (i10 != -1) {
                seasonEpisodeAdapter14 = addTvWatchDialog2.adapter;
                ...
                seasonEpisodeAdapter15 = addTvWatchDialog2.adapter;
            ...
            seasonEpisodeAdapter11 = addTvWatchDialog2.adapter;
            ...
            if (i12 != -1) {
                seasonEpisodeAdapter12 = addTvWatchDialog2.adapter;
                ...
                checkShowProgress2 = addTvWatchDialog2.checkShowProgress(arrayList);
                favoriteItem.setShowProgress(checkShowProgress2);
                seasonEpisodeAdapter13 = addTvWatchDialog2.adapter;
        ...
        int i14 = this.$over;
        AddTvWatchDialog addTvWatchDialog3 = this.this$0;
        ...
        seasonEpisodeAdapter = addTvWatchDialog3.adapter;
        ...
        for (Object obj : seasonEpisodeAdapter.getData()) {
            ...
            if (baseNode instanceof FavoriteEpisodeItem) {
                ...
                if (Intrinsics.areEqual(favoriteEpisodeItem9.getId(), favoriteSeasonItem.getId()) && favoriteEpisodeItem9.getSeason() == favoriteSeasonItem.getSeason()) {
                    ...
                    seasonEpisodeAdapter8 = addTvWatchDialog3.adapter;
        ...
        checkShowProgress = addTvWatchDialog3.checkShowProgress(arrayList2);
        favoriteItem2.setShowProgress(checkShowProgress);
        seasonEpisodeAdapter5 = addTvWatchDialog3.adapter;
        ...
        seasonEpisodeAdapter6 = addTvWatchDialog3.adapter;
