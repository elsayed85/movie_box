...
final class ChooseMultiCountryDialog$initData$4 extends Lambda implements Function2<BaseViewHolder, FilterCountry, Unit> {
    final /* synthetic */ ChooseMultiCountryDialog this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ChooseMultiCountryDialog$initData$4(ChooseMultiCountryDialog chooseMultiCountryDialog) {
        super(2);
        this.this$0 = chooseMultiCountryDialog;
    }
    ...
    public final void invoke2(BaseViewHolder helper, FilterCountry item) {
        ...
        GlideUtils.load(this.this$0.getContext(), item.getIcon(), (ImageView) helper.getView(R.id.imageView));
    }
}
