...
public final class CollectAdapter$FavoriteWatchingProvider$markTv$3 extends Lambda implements Function1<String, Unit> {
    ...
    public CollectAdapter$FavoriteWatchingProvider$markTv$3(CollectAdapter.FavoriteWatchingProvider favoriteWatchingProvider, CollectAdapter.FavoriteWatchingProvider.WatchingAdapter watchingAdapter, int i) {
        super(1);
