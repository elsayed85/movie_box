...
final class CollectAdapter$FavoriteSeasonProvider$getLastEpisode$1 extends Lambda implements Function1<FavoriteItem, Unit> {
    ...
    public CollectAdapter$FavoriteSeasonProvider$getLastEpisode$1(FavoriteItem favoriteItem, CollectAdapter.FavoriteSeasonProvider favoriteSeasonProvider, int i) {
        super(1);
