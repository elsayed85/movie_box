...
public final class SeasonEpisodeAdapter$SeasonProvider$markSeason$3 extends Lambda implements Function1<String, Unit> {
    ...
    public SeasonEpisodeAdapter$SeasonProvider$markSeason$3(SeasonEpisodeAdapter.SeasonProvider seasonProvider, int i, FavoriteSeasonItem favoriteSeasonItem, int i2, Ref.ObjectRef<Integer> objectRef, Ref.ObjectRef<Integer> objectRef2, Ref.ObjectRef<Integer> objectRef3, int i3, Ref.ObjectRef<Integer> objectRef4, int i4, int i5) {
        super(1);
    ...
    */
    public final void invoke2(java.lang.String r18) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.movieboxpro.android.adapter.SeasonEpisodeAdapter$SeasonProvider$markSeason$3.invoke2(java.lang.String):void");
    }
}
