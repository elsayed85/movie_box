...
import com.movieboxpro.android.view.dialog.TrailerPlayerDialogFragment;
...
public final class FragmentUtils {
    ...
    public static void add(FragmentManager fragmentManager, TrailerPlayerDialogFragment.YoutubePlayerFragment youtubePlayerFragment, int i) {
    }
    ...
    public static void add(FragmentManager fragmentManager, Fragment fragment, String str, int i) {
    ...
    public static void show(Fragment fragment, int i) {
        putArgs(fragment, false);
        operateWithAnim(fragment.getFragmentManager(), 2, null, i, 0, fragment);
    }
    ...
    public static void hide(Fragment fragment, int i) {
        putArgs(fragment, true);
        operateWithAnim(fragment.getFragmentManager(), 4, null, 0, i, fragment);
    }
    ...
    private static void operateWithAnim(FragmentManager fragmentManager, int i, Fragment fragment, int i2, int i3, Fragment... fragmentArr) {
        if (fragmentManager == null) {
            return;
        }
        FragmentTransaction beginTransaction = fragmentManager.beginTransaction();
        beginTransaction.setCustomAnimations(i2, i3);
        operate(i, fragmentManager, beginTransaction, fragment, fragmentArr);
    }
