...
public final class ShellUtils {
    ...
    public static Utils.Task<CommandResult> execCmdAsync(final String[] strArr, final boolean z, final boolean z2, Utils.Consumer<CommandResult> consumer) {
        return UtilsBridge.doAsync(new Utils.Task<CommandResult>(consumer) { // from class: com.movieboxpro.android.utils.tool.ShellUtils.1
    ...
    */
    public static com.movieboxpro.android.utils.tool.ShellUtils.CommandResult execCmd(java.lang.String[] r10, boolean r11, boolean r12) {
        /*
            Method dump skipped, instructions count: 386
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.movieboxpro.android.utils.tool.ShellUtils.execCmd(java.lang.String[], boolean, boolean):com.movieboxpro.android.utils.tool.ShellUtils$CommandResult");
    }
