...
public class ZipUtils {
        ...
        try {
            ...
            try {
                for (String str3 : collection) {
                    if (!zipFile(getFileByPath(str3), "", zipOutputStream2, str2)) {
    ...
    public static List<File> unzipFileByKeyword(File file, File file2, String str) throws IOException {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            zipFile = new ZipFile(file, Charset.forName(FileUtils.getCharset(file.getPath())));
        } else {
    ...
    */
    private static boolean unzipChildFile(java.io.File r1, java.util.List<java.io.File> r2, java.util.zip.ZipFile r3, java.util.zip.ZipEntry r4, java.lang.String r5) throws java.io.IOException {
        ...
        L5b:
            goto L5a
        */
        throw new UnsupportedOperationException("Method not decompiled: com.movieboxpro.android.utils.ZipUtils.unzipChildFile(java.io.File, java.util.List, java.util.zip.ZipFile, java.util.zip.ZipEntry, java.lang.String):boolean");
    }
