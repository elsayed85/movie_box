...
public class FragmentRecommendBindingImpl extends FragmentRecommendBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.ivRefresh, 1);
        sViewsWithIds.put(R.id.ivManager, 2);
    ...
    private FragmentRecommendBindingImpl(DataBindingComponent dataBindingComponent, View view, Object[] objArr) {
        super(dataBindingComponent, view, 0, (FrameLayout) objArr[3], (AppCompatImageView) objArr[2], (AppCompatImageView) objArr[1]);
        this.mDirtyFlags = -1L;
